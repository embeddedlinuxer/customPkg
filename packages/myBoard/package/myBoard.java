...
public class myBoard
{
    ...
    void Platform$$TYPES()
    {
        ...
        po.init("myBoard.Platform.Instance", om.findStrict("xdc.platform.IPlatform.Instance", "myBoard"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("codeMemory", $$T_Str, "APP_CODE_MEM", "wh");
        po.addFld("dataMemory", $$T_Str, "APP_CACHED_DATA_MEM", "wh");
        po.addFld("stackMemory", $$T_Str, "APP_CACHED_DATA_MEM", "wh");
    ...
    void $$INITIALIZATION()
    {
        ...
        vo = (Value.Obj)om.findStrict("myBoard.Platform", "myBoard");
        Global.put(vo, "CPU", Global.callFxn("create", (Scriptable)om.find("ti.platforms.generic.Platform"), "CPU", Global.newObject("clockRate", 300L, "catalogName", "ti.catalog.c6000", "deviceName", "TMS320C6748", "customMemoryMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"IROM", Global.newObject("name", "IROM", "base", 0x11700000L, "len", 0x00100000L, "space", "code/data", "access", "RX")}), Global.newArray(new Object[]{"IRAM", Global.newObject("name", "IRAM", "base", 0x11800000L, "len", 0x00040000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"L3_CBA_RAM", Global.newObject("name", "L3_CBA_RAM", "base", 0x80000000L, "len", 0x00020000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"APP_CODE_MEM", Global.newObject("name", "APP_CODE_MEM", "base", 0xC0000000L, "len", 0x1e00000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"APP_CACHED_DATA_MEM", Global.newObject("name", "APP_CACHED_DATA_MEM", "base", 0xc1f01000L, "len", 0x1400000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"APP_UNCACHED_DATA_BLK3_MEM", Global.newObject("name", "APP_UNCACHED_DATA_BLK3_MEM", "base", 0xc3301000L, "len", 0x1400000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"APP_CACHED_DATA_BLK1_MEM", Global.newObject("name", "APP_CACHED_DATA_BLK1_MEM", "base", 0xc4701000L, "len", 0xa00000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"APP_CACHED_DATA_BLK2_MEM", Global.newObject("name", "APP_CACHED_DATA_BLK2_MEM", "base", 0xc5101000L, "len", 0xa00000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"APP_CACHED_BIOS_RSVD_MEM", Global.newObject("name", "APP_CACHED_BIOS_RSVD_MEM", "base", 0xc5b01000L, "len", 0x1000000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"DDR_CFG", Global.newObject("name", "DDR_CFG", "base", 0xc6b01000L, "len", 0xa00000L, "space", "code/data", "access", "RWX")})}), "l1DMode", "32k", "l1PMode", "32k", "l2Mode", "0k")));
